...
class Players(Base):
    ...
    att_wr: Mapped[str] = mapped_column(Text, nullable=True)
    def_wr: Mapped[str] = mapped_column(Text, nullable=True)
    height: Mapped[str] = mapped_column(Text, nullable=False)
    weight: Mapped[str] = mapped_column(Text, nullable=True)

    # Standard Stats
    acceleration: Mapped[int] = mapped_column(Integer, nullable=True)
    sprint_speed: Mapped[int] = mapped_column(Integer, nullable=True)
    positioning: Mapped[int] = mapped_column(Integer, nullable=True)
    finishing: Mapped[int] = mapped_column(Integer, nullable=True)
    shot_power: Mapped[int] = mapped_column(Integer, nullable=True)
    long_shots: Mapped[int] = mapped_column(Integer, nullable=True)
    volleys: Mapped[int] = mapped_column(Integer, nullable=True)
    penalties: Mapped[int] = mapped_column(Integer, nullable=True)
    ...
    ball_control: Mapped[int] = mapped_column(Integer, nullable=True)
    dribbling: Mapped[int] = mapped_column(Integer, nullable=True)
    composure: Mapped[int] = mapped_column(Integer, nullable=True)
    ...
    jumping: Mapped[int] = mapped_column(Integer, nullable=True)
    stamina: Mapped[int] = mapped_column(Integer, nullable=True)
    strength: Mapped[int] = mapped_column(Integer, nullable=True)
    aggression: Mapped[int] = mapped_column(Integer, nullable=True)
